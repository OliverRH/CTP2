...
payload = '"battery":100,"illuminance":839,"illuminance_lux":839,"linkquality":141,"occupancy":true,"temperature":25,"voltage":3025,"room":' + room + ''
...
client.publish("zigbee2mqtt/0x00158d0005729f18", payload) 
client.disconnect()
